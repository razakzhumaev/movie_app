...
@RoutePage()
class UpcomingInfoScreen extends StatefulWidget {
  final UpComingModel upComingModel;
  final int id;

  const UpcomingInfoScreen({
    Key? key,
  ...
  @override
  State<UpcomingInfoScreen> createState() => _UpcomingInfoScreenState();
}

class _UpcomingInfoScreenState extends State<UpcomingInfoScreen> {
          ...
          SliverAppBar.large(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: ClipRRect(
                ...
                child: Image.network(
                  'https://image.tmdb.org/t/p/w500${widget.upComingModel.posterPath}',
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    widget.upComingModel.overview.toString(),
                              ...
                              RichText(
                                text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text: widget.upComingModel.releaseDate
                                          .toString()
                                          .substring(
                                            0,
                                            widget.upComingModel.releaseDate
                                                    .toString()
                                                    .length -
                                                12,
                                          ),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                ' ${widget.upComingModel.voteAverage?.toStringAsFixed(1)} / 10',
                                style: const TextStyle(
                                  color: Colors.white,
                                ),
                              ),
